package practicaltest02.eim.systems.cs.pub.ro.test.view;
...
import practicaltest02.eim.systems.cs.pub.ro.test.Constants;
import practicaltest02.eim.systems.cs.pub.ro.test.R;
import practicaltest02.eim.systems.cs.pub.ro.test.network.ClientThread;
import practicaltest02.eim.systems.cs.pub.ro.test.network.ServerThread;
...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    private EditText locationUrl = null;
    ...
    private class GetWeatherForecastButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            String city = locationUrl.getText().toString();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationUrl = (EditText)findViewById(R.id.city_edit_text);
